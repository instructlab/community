...
- Upon all maintainers agreement or lazy consensus among them in three week time frame, a maintainer will create PR to add you in the CODEOWNERS/MAINTAINER file.
