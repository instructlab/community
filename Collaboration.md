...
Weekly InstructLab CLI meetings will feature announcements from the 
CLI Maintainers](MAINTAINERS.md) team about the CLI project, overviews
of the general roadmap the project is taking via our 
[Milestones](https://github.com/instructlab/instructlab/milestones) and
dedicated time for discussing the direction of the project.
